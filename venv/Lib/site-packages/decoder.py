    ...
    test = {'one': {'@class': {'id': 'test'}},
            ...
            'three': {'@rss': {'version': '2.0', 'author': 'Mc.Spring'},
                      'rss': {'channel': {'language': 'en-us',
                                          ...
                                          'title': 'Spring Mc',
                                          'item': [{'category': 'skill', 'guid': 'https://github.com/mcspring/googl.go',
                                                    'link': 'https://github.com/mcspring/googl.go',
                                                    '@link': {'target': '_blank'},
                                                    'pubDate': 'Mon, 13 Apr 2011 02:04:52 +0800',
                                                    'author': 'Heresy.Mc@gmail.com(Spring Mc)',
                                                    'title': 'This is googl.go proejct',
                                                    'description': 'This is the first project written in go, thanks!'},
                                                   {'category': 'skill', 'guid': 'https://github.com/mcspring/XML2Dict',
                                                    'link': 'https://github.com/mcspring/XML2Dict',
                                                    '@link': {'target': '_blank'},
                                                    'pubDate': 'Mon, 15 Apr 2009 02:04:52 +0800',
                                                    'author': 'Heresy.Mc@gmail.com(Spring Mc)',
                                                    'title': 'This is XML2Dict project',
                                                    'description': 'This is the first project written in python, thanks!'}],
                                          'image': {'url': 'https://github.com/mcspring/logo.gif',
                                                    'link': 'https://github.com/mcspring/', 'description': 'Spring Mc',
                                                    'title': 'Spring on github'},
