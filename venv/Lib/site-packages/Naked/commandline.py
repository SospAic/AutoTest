...
class Command:
    ...
    def app_validates_args(self):
        try:
            ...
            if DEBUG_FLAG:
                sys.stderr.write(
                    "Naked Framework Error: Validation of application error in the app_validates() method (Naked.commandline.py).")
            raise e
    ...
    def arg(self, arg_recipient):
        try:
            ...
            if DEBUG_FLAG:
                sys.stderr.write(
                    "Naked Framework Error: Error parsing argument with arg() method (Naked.commandline.py).")
            raise e
    ...
    def command(self, cmd_str):
        try:
            ...
            if DEBUG_FLAG:
                sys.stderr.write(
                    "Naked Framework Error: Error parsing command with command() method (Naked.commandline.py).")
            raise e
    ...
    def command_arg(self):
        try:
            ...
            if DEBUG_FLAG:
                sys.stderr.write(
                    "Naked Framework Error: Error parsing command argument with command_arg() method (Naked.commandline.py).")
            raise e
    ...
    def command_with_argument(self, cmd_str):
        try:
            ...
            if DEBUG_FLAG:
                sys.stderr.write(
                    "Naked Framework Error: Error parsing command and argument with command_with_argument() method (Naked.commandline.py).")
            raise e
    ...
    def command_suite_validates(self, accept_options_as_argument=True):
        try:
            ...
            if DEBUG_FLAG:
                sys.stderr.write(
                    "Naked Framework Error: Command suite validation error with the command_suite_validation() method (Naked.commandline.py).")
            raise e
    ...
    def flag(self, flag_string):
        try:
            ...
            if DEBUG_FLAG:
                sys.stderr.write(
                    "Naked Framework Error: Error parsing flags with the flag() method (Naked.commandline.py).")
            raise e
        ...
        try:
            for match_string in self.optobj:
                if match_string.startswith(flag_string) and '=' in match_string:
                    flag_list = match_string.split(
                        "=")  # split the flag on the equal symbol = list with [option, argument]
            ...
            if DEBUG_FLAG:
                sys.stderr.write(
                    "Naked Framework Error: Error parsing flags with the flag_arg() method (Naked.commandline.py).")
            raise e
    ...
    def option(self, option_string, argument_required=False):
        try:
            ...
            if DEBUG_FLAG:
                sys.stderr.write(
                    "Naked Framework Error: Error parsing option with option() method (Naked.commandline.py).")
            raise e
    ...
    def option_arg(self, option_string):
        try:
            ...
            if DEBUG_FLAG:
                sys.stderr.write(
                    "Naked Framework Error: Error returning argument to option with option_arg() method (Naked.commandline.py).")
            raise e
    ...
    def option_with_arg(self, option_string, argument_required=True):
        try:
            ...
            if DEBUG_FLAG:
                sys.stderr.write(
                    "Naked Framework Error: Error parsing option and argument with option_with_arg() method (Naked.commandline.py).")
            raise e
    ...
    def option_exists(self):
        try:
            ...
            if DEBUG_FLAG:
                sys.stderr.write(
                    "Naked Framework Error: Error testing for the presence of at least one option with option_exists() method (Naked.commandline.py).")
            raise e
