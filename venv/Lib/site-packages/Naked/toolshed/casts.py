...
def xl(list_arg, attributes={}):
    try:
        ...
        if DEBUG_FLAG:
            print(
                "Naked Framework Error: unable to cast object to a XList with the xl() function (Naked.toolshed.casts.py).")
        raise e
...
def xq(queue_arg, attributes={}):
    try:
        ...
        if DEBUG_FLAG:
            print(
                "Naked Framework Error: unable to cast object to a XQueue with the xq() function (Naked.toolshed.casts.py).")
        raise e
...
def xset(set_arg, attributes={}):
    try:
        ...
        if DEBUG_FLAG:
            print(
                "Naked Framework Error: unable to cast object to a XSet with the xset() function (Naked.toolshed.casts.py).")
        raise e
...
def xstr(string_arg, attributes={}):
    try:
        ...
        if DEBUG_FLAG:
            print(
                "Naked Framework Error: unable to cast object to a XString with the xstr() function (Naked.toolshed.casts.py).")
        raise e
...
def xt(tup_arg, attributes={}):
    try:
        ...
        if DEBUG_FLAG:
            print(
                "Naked Framework Error: unable to cast object to a XTuple with the xt() function (Naked.toolshed.casts.py).")
        raise e
