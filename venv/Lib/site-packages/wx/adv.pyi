...
class CommandLinkButton(wx.Button):
    ...
    def Create(self, parent, id=wx.ID_ANY, mainLabel=wx.EmptyString, note=wx.EmptyString, pos=wx.DefaultPosition,
...
class DatePickerCtrl(wx.Control):
    ...
    def Create(self, parent, id=wx.ID_ANY, dt=wx.DefaultDateTime, pos=wx.DefaultPosition, size=wx.DefaultSize,
               style=DP_DEFAULT | DP_SHOWCENTURY, validator=wx.DefaultValidator, name="datectrl"):
        """
...
class CalendarCtrl(wx.Control):
    ...
    def Create(self, parent, id=wx.ID_ANY, date=wx.DefaultDateTime, pos=wx.DefaultPosition, size=wx.DefaultSize,
               style=CAL_SHOW_HOLIDAYS, name=CalendarNameStr):
        """
...
class HyperlinkCtrl(wx.Control):
    ...
    def Create(self, parent, id=wx.ID_ANY, label=wx.EmptyString, url=wx.EmptyString, pos=wx.DefaultPosition,
               size=wx.DefaultSize, style=HL_DEFAULT_STYLE, name=HyperlinkCtrlNameStr):
        """
...
class AnimationCtrl(wx.Control):
    ...
    def __init__(self, parent, id=wx.ID_ANY, anim=NullAnimation, pos=wx.DefaultPosition, size=wx.DefaultSize,
                 style=AC_DEFAULT_STYLE, name=AnimationCtrlNameStr):
        """
        AnimationCtrl(parent, id=wx.ID_ANY, anim=NullAnimation, pos=wx.DefaultPosition, size=wx.DefaultSize, style=AC_DEFAULT_STYLE, name=AnimationCtrlNameStr)
    ...
    def Create(self, parent, id=wx.ID_ANY, anim=NullAnimation, pos=wx.DefaultPosition, size=wx.DefaultSize,
               style=AC_DEFAULT_STYLE, name=AnimationCtrlNameStr):
        """
...
class BannerWindow(wx.Window):
    ...
    def Create(self, parent, winid=wx.ID_ANY, dir=wx.LEFT, pos=wx.DefaultPosition, size=wx.DefaultSize, style=0,
               name=BannerWindowNameStr):
        """
...
class EditableListBox(wx.Panel):
    ...
    def Create(self, parent, id=wx.ID_ANY, label=wx.EmptyString, pos=wx.DefaultPosition, size=wx.DefaultSize,
               style=EL_DEFAULT_STYLE, name=EditableListBoxNameStr):
        """
...
class SplashScreen(wx.Frame):
    ...
    def __init__(self, bitmap, splashStyle, milliseconds, parent, id=wx.ID_ANY, pos=wx.DefaultPosition,
                 size=wx.DefaultSize, style=wx.BORDER_SIMPLE | wx.FRAME_NO_TASKBAR | wx.STAY_ON_TOP):
        """
        SplashScreen(bitmap, splashStyle, milliseconds, parent, id=wx.ID_ANY, pos=wx.DefaultPosition, size=wx.DefaultSize, style=wx.BORDER_SIMPLE|wx.FRAME_NO_TASKBAR|wx.STAY_ON_TOP)
...
class SashLayoutWindow(SashWindow):
    ...
    def Create(self, parent, id=wx.ID_ANY, pos=wx.DefaultPosition, size=wx.DefaultSize, style=wx.CLIP_CHILDREN | SW_3D,
               name="layoutWindow"):
        """
...
class OwnerDrawnComboBox(wx.ComboCtrl, wx.ItemContainer):
    ...
    def Create(self, parent, id=wx.ID_ANY, value=wx.EmptyString, pos=wx.DefaultPosition, size=wx.DefaultSize,
               choices=[], style=0, validator=wx.DefaultValidator, name=wx.ComboBoxNameStr):
        """
...
class BitmapComboBox(wx.Control, wx.TextEntry, wx.ItemContainer):
    ...
    def Create(self, parent, id=wx.ID_ANY, value=wx.EmptyString, pos=wx.DefaultPosition, size=wx.DefaultSize,
               choices=[], style=0, validator=wx.DefaultValidator, name=BitmapComboBoxNameStr):
        """
...
class TimePickerCtrl(wx.Control):
    ...
    def Create(self, parent, id=wx.ID_ANY, dt=wx.DefaultDateTime, pos=wx.DefaultPosition, size=wx.DefaultSize,
               style=DP_DEFAULT | DP_SHOWCENTURY, validator=wx.DefaultValidator, name="timectrl"):
        """
...
class Wizard(wx.Dialog):
    ...
    def Create(self, parent, id=wx.ID_ANY, title=wx.EmptyString, bitmap=wx.NullBitmap, pos=wx.DefaultPosition,
...
class PropertySheetDialog(wx.Dialog):
    ...
    def Create(self, parent, id=wx.ID_ANY, title=wx.EmptyString, pos=wx.DefaultPosition, size=wx.DefaultSize,
