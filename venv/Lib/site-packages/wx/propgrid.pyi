...
class PropertyGridInterface(object):
    ...
    def GetPropertiesWithFlag(self, targetArr, flags, inverse=False,
                              iterFlags=PG_ITERATE_PROPERTIES | PG_ITERATE_HIDDEN | PG_ITERATE_CATEGORIES):
        """
    ...
    def SetPropertyCell(self, id, column, text=wx.EmptyString, bitmap=wx.NullBitmap, fgCol=wx.NullColour,
                        bgCol=wx.NullColour):
        """
...
class PropertyGrid(wx.Control, PropertyGridInterface):
    ...
    def Create(self, parent, id=wx.ID_ANY, pos=wx.DefaultPosition, size=wx.DefaultSize, style=PG_DEFAULT_STYLE,
               name=PropertyGridNameStr):
        """
...
class PropertyGridManager(wx.Panel, PropertyGridInterface):
    ...
    def Create(self, parent, id=wx.ID_ANY, pos=wx.DefaultPosition, size=wx.DefaultSize, style=PGMAN_DEFAULT_STYLE,
