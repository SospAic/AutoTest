...
GridBagSizer.CheckForIntersectionPos = wx.deprecated(GridBagSizer.CheckForIntersection,
                                                     'Use CheckForIntersection instead.')
...
Window.ConvertDialogPointToPixels = wx.deprecated(_Window_ConvertDialogPointToPixels,
                                                  "Use ConvertDialogToPixels instead.")
...
Window.ConvertDialogSizeToPixels = wx.deprecated(_Window_ConvertDialogSizeToPixels,
                                                 "Use ConvertDialogToPixels instead.")
...
def _ToolBar_AddLabelTool(self, id, label, bitmap, bmpDisabled=wx.NullBitmap, kind=wx.ITEM_NORMAL, shortHelp="",
...
def _ToolBar_InsertLabelTool(self, pos, id, label, bitmap, bmpDisabled=wx.NullBitmap, kind=wx.ITEM_NORMAL, shortHelp="",
                             longHelp="", clientData=None):
    """
    Old style method to insert a tool in the toolbar.
    """
...
TreeItemData = deprecated(TreeItemData,
