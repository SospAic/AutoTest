...
class DataViewCtrl(wx.Control):
    ...
    def Create(self, parent, id=wx.ID_ANY, pos=wx.DefaultPosition, size=wx.DefaultSize, style=0,
               validator=wx.DefaultValidator, name=DataViewCtrlNameStr):
        """
...
class DataViewListCtrl(DataViewCtrl):
    ...
    def AppendTextColumn(self, label, mode=DATAVIEW_CELL_INERT, width=-1, align=wx.ALIGN_LEFT,
                         flags=DATAVIEW_COL_RESIZABLE):
        """
    ...
    def AppendToggleColumn(self, label, mode=DATAVIEW_CELL_ACTIVATABLE, width=-1, align=wx.ALIGN_LEFT,
                           flags=DATAVIEW_COL_RESIZABLE):
        """
    ...
    def AppendProgressColumn(self, label, mode=DATAVIEW_CELL_INERT, width=-1, align=wx.ALIGN_LEFT,
                             flags=DATAVIEW_COL_RESIZABLE):
        """
    ...
    def AppendIconTextColumn(self, label, mode=DATAVIEW_CELL_INERT, width=-1, align=wx.ALIGN_LEFT,
                             flags=DATAVIEW_COL_RESIZABLE):
        """
    ...
    def Create(self, parent, id=wx.ID_ANY, pos=wx.DefaultPosition, size=wx.DefaultSize, style=DV_ROW_LINES,
...
class DataViewTreeCtrl(DataViewCtrl):
    ...
    def Create(self, parent, id=wx.ID_ANY, pos=wx.DefaultPosition, size=wx.DefaultSize,
               style=DV_NO_HEADER | DV_ROW_LINES, validator=wx.DefaultValidator):
        """
...
class TreeListCtrl(wx.Window):
    ...
    def Create(self, parent, id=wx.ID_ANY, pos=wx.DefaultPosition, size=wx.DefaultSize, style=TL_DEFAULT_STYLE,
