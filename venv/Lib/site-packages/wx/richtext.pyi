...
class RichTextObject(wx.Object):
    ...
    def GetRangeSize(self, range, size, descent, dc, context, flags, position=wx.Point(0, 0), parentSize=wx.DefaultSize,
                     partialExtents=None):
        """
    ...
    def LayoutToBestSize(self, dc, context, buffer, parentAttr, attr, availableParentSpace, availableContainerSpace,
                         style):
        """
...
class RichTextParagraphLayoutBox(RichTextCompositeObject):
    ...
    def DoNumberList(self, range, promotionRange, promoteBy, styleDef, flags=RICHTEXT_SETSTYLE_WITH_UNDO, startFrom=1,
                     specifiedLevel=-1):
        """
...
class RichTextFieldType(wx.Object):
    ...
    def GetRangeSize(self, obj, range, size, descent, dc, context, flags, position=wx.Point(0, 0),
                     parentSize=wx.DefaultSize, partialExtents=None):
        """
...
class RichTextBuffer(RichTextParagraphLayoutBox):
    ...
    def BeginNumberedBullet(self, bulletNumber, leftIndent, leftSubIndent,
                            bulletStyle=wx.TEXT_ATTR_BULLET_STYLE_ARABIC | wx.TEXT_ATTR_BULLET_STYLE_PERIOD):
        """
    ...
    def BeginStandardBullet(self, bulletName, leftIndent, leftSubIndent,
...
class RichTextAction(wx.Object):
    ...
    def UpdateAppearance(self, caretPosition, sendUpdateEvent=False, optimizationLineCharPositions=None,
                         optimizationLineYPositions=None, isDoCmd=True):
        """
...
class RichTextCtrl(wx.Control):
    ...
    def Create(self, parent, id=-1, value=wx.EmptyString, pos=wx.DefaultPosition, size=wx.DefaultSize,
               style=RE_MULTILINE, validator=wx.DefaultValidator, name=wx.TextCtrlNameStr):
        """
...
class RichTextStyleOrganiserDialog(wx.Dialog):
    ...
    def Create(self, flags, sheet, ctrl, parent, id=wx.ID_ANY, caption=wx.GetTranslation("StyleOrganiser"),
               pos=wx.DefaultPosition, size=wx.Size(400, 300),
               style=wx.DEFAULT_DIALOG_STYLE | wx.RESIZE_BORDER | wx.SYSTEM_MENU | wx.CLOSE_BOX):
        """
...
class SymbolPickerDialog(wx.Dialog):
    ...
    def Create(self, symbol, initialFont, normalTextFont, parent, id=wx.ID_ANY, caption=wx.GetTranslation("Symbols"),
               pos=wx.DefaultPosition, size=wx.Size(400, 300),
...
class RichTextFormattingDialog(wx.adv.PropertySheetDialog):
    ...
    def Create(self, flags, parent, title=wx.GetTranslation("Formatting"), id=wx.ID_ANY, pos=wx.DefaultPosition,
               sz=wx.DefaultSize, style=wx.DEFAULT_DIALOG_STYLE):
        """
