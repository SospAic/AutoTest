...
class HtmlHelpFrame(wx.Frame):
    ...
    def Create(self, parent, id=wx.ID_ANY, title=wx.EmptyString, style=HF_DEFAULT_STYLE, config=None,
               rootpath=wx.EmptyString):
        """
...
class HtmlHelpWindow(wx.Window):
    ...
    def Create(self, parent, id=wx.ID_ANY, pos=wx.DefaultPosition, size=wx.DefaultSize,
               style=wx.TAB_TRAVERSAL | wx.BORDER_NONE, helpStyle=HF_DEFAULT_STYLE):
        """
...
class SimpleHtmlListBox(HtmlListBox, wx.ItemContainer):
    ...
    def Create(self, parent, id=wx.ID_ANY, pos=wx.DefaultPosition, size=wx.DefaultSize, choices=[],
               style=HLB_DEFAULT_STYLE, validator=wx.DefaultValidator, name=SimpleHtmlListBoxNameStr):
        """
