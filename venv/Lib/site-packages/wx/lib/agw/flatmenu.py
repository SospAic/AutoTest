...
class FMRenderer(object):
    ...
    def __init__(self):
        ...
        self.itemTextColourDisabled = ArtManager.Get().LightColour(wx.SystemSettings.GetColour(wx.SYS_COLOUR_GRAYTEXT),
                                                                   30)
        ...
        if self._showToolbar and invT > 0:
            ...
            for i in range(len(self._tbButtons) - invT, len(self._tbButtons)):
                if self._tbButtons[i]._tbItem.IsSeparator():
                    ...
                    tbitem = self._tbButtons[i]._tbItem
                    item = FlatMenuItem(self._tbMenu, tbitem.GetId(), tbitem.GetLabel(), "", wx.ITEM_NORMAL, None,
                                        tbitem.GetBitmap(), tbitem.GetDisabledBitmap())
