        ...
        if self._isDragging:
            ...
            if event.LeftDown() or event.RightUp():
                if hit_border and event.LeftDown():
                    ...
                    evt = \
                    (event.LeftDown() and [wx.wxEVT_COMMAND_LIST_COL_CLICK] or [wx.wxEVT_COMMAND_LIST_COL_RIGHT_CLICK])[
                        0]
...
class TreeListMainWindow(CustomTreeCtrl):
    ...
    def ChildrenClosing(self, item):
        ...
        if self._editCtrl != None and item != self._editCtrl.item() and self.IsDescendantOf(item,
                                                                                            self._editCtrl.item()):
            self._editCtrl.StopEditing()
    ...
    def OnMouse(self, event):
        ...
        if event.Dragging():
            ...
            command = \
            (event.LeftIsDown() and [wx.wxEVT_COMMAND_TREE_BEGIN_DRAG] or [wx.wxEVT_COMMAND_TREE_BEGIN_RDRAG])[0]
...
_methods = ["GetIndent", "SetIndent", "GetSpacing", "SetSpacing", "GetImageList", "GetStateImageList",
            ...
            "SetItemVisited", "GetItemVisited", "SetHilightFocusColour", "GetHilightFocusColour",
            ...
            "IsDescendantOf", "SetItemHyperText", "IsItemHyperText", "SetItemBold", "SetItemDropHighlight",
            "SetItemItalic",
