            ...
            if item.HasPlus() and self.HasButtons():
                ...
                if self._imageListButtons:
                    ...
                    if self.HasAGWFlag(TR_TWIST_BUTTONS):
                        ...
                        self._drawingfunction(self, dc, wx.Rect(x - wImage // 2, y_mid - hImage // 2, wImage, hImage),
                                              flag)
    ...
    def OnMouse(self, event):
        ...
        if event.Dragging() and not self._isDragging and (
            ...
            if event.RightDown():
                ...
                if item.GetType() > 0 and (flags & TREE_HITTEST_ONITEMCHECKICON) and (
                        flags & TREE_HITTEST_ONITEMLABEL == 0):
