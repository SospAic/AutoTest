...
class RibbonMSWArtProvider(object):
    ...
    def SetColourScheme(self, primary, secondary, tertiary):
        ...
        self._panel_minimised_border_gradient_pen = wx.Pen(
            LikePrimary(primary_hsl, primary_is_gray, -6.9, -0.17, -0.09))
        ...
        self._panel_hover_button_background_brush = wx.Brush(
            LikeSecondary(secondary_hsl, secondary_is_gray, -0.9, 0.16, -0.07))
        self._panel_hover_button_border_pen = wx.Pen(
            LikeSecondary(secondary_hsl, secondary_is_gray, -3.9, -0.16, -0.14))
        self.SetColour(RIBBON_ART_PANEL_BUTTON_FACE_COLOUR,
                       LikePrimary(primary_hsl, primary_is_gray, 1.4, -0.21, -0.23))
        self.SetColour(RIBBON_ART_PANEL_BUTTON_HOVER_FACE_COLOUR,
                       LikePrimary(primary_hsl, primary_is_gray, 1.5, -0.24, -0.29))

        self._gallery_button_disabled_background_colour = LikePrimary(primary_hsl, primary_is_gray, -2.8, -0.46, 0.09)
        self._gallery_button_disabled_background_top_brush = wx.Brush(
            LikePrimary(primary_hsl, primary_is_gray, -2.8, -0.36, 0.15))
        ...
        self.SetColour(RIBBON_ART_GALLERY_BUTTON_DISABLED_FACE_COLOUR,
                       LikePrimary(primary_hsl, primary_is_gray, 0.0, -1.0, 0.0))
        self._gallery_button_disabled_background_gradient_colour = LikePrimary(primary_hsl, primary_is_gray, 1.5, -0.43,
                                                                               0.12)
        ...
        self._gallery_button_hover_background_colour = LikeSecondary(secondary_hsl, secondary_is_gray, -0.9, 0.16,
                                                                     -0.07)
        self._gallery_button_hover_background_gradient_colour = LikeSecondary(secondary_hsl, secondary_is_gray, 0.1,
                                                                              0.12, 0.03)
        self._gallery_button_hover_background_top_brush = wx.Brush(
            LikeSecondary(secondary_hsl, secondary_is_gray, 4.3, 0.16, 0.17))

        self._gallery_button_active_background_colour = LikeSecondary(secondary_hsl, secondary_is_gray, -9.9, 0.03,
                                                                      -0.22)
        self._gallery_button_active_background_gradient_colour = LikeSecondary(secondary_hsl, secondary_is_gray, -9.5,
                                                                               0.14, -0.11)
        self._gallery_button_active_background_top_brush = wx.Brush(
            LikeSecondary(secondary_hsl, secondary_is_gray, -9.0, 0.15, -0.08))
        ...
        self._button_bar_hover_background_gradient_colour = LikeSecondary(secondary_hsl, secondary_is_gray, -0.6, 0.16,
                                                                          0.04)
        self._button_bar_hover_background_colour = LikeSecondary(secondary_hsl, secondary_is_gray, -0.2, 0.16, -0.10)
        self._button_bar_hover_background_top_gradient_colour = LikeSecondary(secondary_hsl, secondary_is_gray, 0.2,
                                                                              0.16, 0.03)
        ...
        self._button_bar_active_background_top_colour = LikeSecondary(secondary_hsl, secondary_is_gray, -8.4, 0.08,
                                                                      0.06)
        self._button_bar_active_background_top_gradient_colour = LikeSecondary(secondary_hsl, secondary_is_gray, -9.7,
                                                                               0.13, -0.07)
        self._button_bar_active_background_colour = LikeSecondary(secondary_hsl, secondary_is_gray, -9.9, 0.14, -0.14)
        self._button_bar_active_background_gradient_colour = LikeSecondary(secondary_hsl, secondary_is_gray, -8.7, 0.17,
                                                                           -0.03)
        ...
        self._tool_hover_background_top_gradient_colour = LikeSecondary(secondary_hsl, secondary_is_gray, -1.4, 0.04,
                                                                        0.08)
        ...
        self._tool_active_background_top_gradient_colour = LikeSecondary(secondary_hsl, secondary_is_gray, -8.5, 0.16,
                                                                         -0.12)
        self._tool_active_background_colour = LikeSecondary(secondary_hsl, secondary_is_gray, -7.9, 0.16, -0.20)
        self._tool_active_background_gradient_colour = LikeSecondary(secondary_hsl, secondary_is_gray, -6.6, 0.16,
                                                                     -0.10)
    ...
    def DrawScrollButton(self, dc, wnd, rect_, style):
        ...
        dc.SetPen(wx.TRANSPARENT_PEN)
        B = wx.Brush(
            (style & RIBBON_SCROLL_BTN_HOVERED and [self._tab_active_background_colour] or [self._tab_label_colour])[0])
        dc.SetBrush(B)
    ...
    def DrawPanelBackground(self, dc, wnd, rect):
        ...
        if has_ext_button:
            if wnd.IsExtButtonHovered():
                ...
                dc.DrawBitmap(self._panel_extension_bitmap[1], label_rect.GetRight() + 3, label_rect.GetBottom() - 10,
                              True)
            else:
                dc.DrawBitmap(self._panel_extension_bitmap[0], label_rect.GetRight() + 3, label_rect.GetBottom() - 10,
                              True)
    ...
    def DrawGalleryBackgroundCommon(self, dc, wnd, rect):
        ...
        if self._flags & RIBBON_BAR_FLOW_VERTICAL:
            ...
            ext_btn = wx.Rect(down_btn.GetRight() + 1, up_btn.GetTop(),
                              rect.width - up_btn.GetWidth() - down_btn.GetWidth() - 1, up_btn.GetHeight())
            ...
            ext_btn = wx.Rect(up_btn.GetLeft(), down_btn.GetBottom() + 1, up_btn.GetWidth(),
    ...
    def DrawTool(self, dc, wnd, rect, bitmap, kind, state):
        ...
        is_split_hybrid = (kind == RIBBON_BUTTON_HYBRID and (
                    state & (RIBBON_TOOLBAR_TOOL_HOVER_MASK | RIBBON_TOOLBAR_TOOL_ACTIVE_MASK)))
    ...
    def GetPageBackgroundRedrawArea(self, dc, wnd, page_old_size, page_new_size):
        ...
        if page_new_size.GetWidth() != page_old_size.GetWidth():
            if page_new_size.GetHeight() != page_old_size.GetHeight():
                ...
                right_edge_width = 4
                new_rect = wx.Rect(page_new_size.GetWidth() - right_edge_width, 0, right_edge_width,
                                   page_new_size.GetHeight())
                old_rect = wx.Rect(page_old_size.GetWidth() - right_edge_width, 0, right_edge_width,
