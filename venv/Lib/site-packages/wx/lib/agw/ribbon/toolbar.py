...
class RibbonToolBar(RibbonControl):
    ...
    def AddTool(self, tool_id, bitmap, bitmap_disabled=wx.NullBitmap, help_string="", kind=RIBBON_BUTTON_NORMAL,
                client_data=None):
        """
    ...
    def InsertTool(self, pos, tool_id, bitmap, bitmap_disabled=wx.NullBitmap, help_string="", kind=RIBBON_BUTTON_NORMAL,
                   client_data=None):
        """
    ...
    def Realize(self):
        ...
        for group in self._groups:
            ...
            for t, tool in enumerate(group.tools):
                ...
                tool.size, tool.dropdown = self._art.GetToolSize(temp_dc, self, tool.bitmap.GetSize(), tool.kind,
                                                                 t == 0, t == (tool_count - 1))
