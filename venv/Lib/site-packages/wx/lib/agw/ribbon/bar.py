...
class RibbonBar(RibbonControl):
    ...
    def __init__(self, parent, id=wx.ID_ANY, pos=wx.DefaultPosition, size=wx.DefaultSize,
                 agwStyle=RIBBON_BAR_DEFAULT_STYLE,
    ...
    def AddPage(self, page):
        ...
        info.small_must_have_separator_width, info.minimum_width = self._art.GetBarTabWidth(dcTemp, self, label, icon,
                                                                                            info.ideal_width,
    ...
    def OnMouseMove(self, event):
        ...
        if self._tab_scroll_buttons_shown:
            if self._tab_scroll_left_button_rect.Contains((x, y)):
                self._tab_scroll_left_button_state, refresh_tabs = SET_FLAG(self._tab_scroll_left_button_state,
                                                                            RIBBON_SCROLL_BTN_HOVERED)
            else:
                self._tab_scroll_left_button_state, refresh_tabs = UNSET_FLAG(self._tab_scroll_left_button_state,
                                                                              RIBBON_SCROLL_BTN_HOVERED)

            if self._tab_scroll_right_button_rect.Contains((x, y)):
                self._tab_scroll_right_button_state, refresh_tabs = SET_FLAG(self._tab_scroll_right_button_state,
                                                                             RIBBON_SCROLL_BTN_HOVERED)
            else:
                self._tab_scroll_right_button_state, refresh_tabs = UNSET_FLAG(self._tab_scroll_right_button_state,
                                                                               RIBBON_SCROLL_BTN_HOVERED)
    ...
    def RecalculateTabSizes(self):
        ...
        if width >= self._tabs_total_width_ideal:
            ...
            self._tab_scroll_right_button_rect.SetX(
                self.GetClientSize().GetWidth() - self._tab_margin_right - self._tab_scroll_right_button_rect.GetWidth())
            ...
            if self._tab_scroll_amount == 0:
                ...
                self._tab_scroll_right_button_rect.SetX(
                    self._tab_scroll_right_button_rect.GetX() + self._tab_scroll_right_button_rect.GetWidth())
                self._tab_scroll_right_button_rect.SetWidth(0)
            ...
            if width >= total_small_width:
                ...
                for info in self._pages:
                    ...
                    info.rect.x = x
                    info.rect.y = y
                    info.rect.width = info.small_must_have_separator_width + delta * (
                                width - total_small_width) / total_delta
                    info.rect.height = self._tab_height
    ...
    def HitTestTabs(self, position):
        ...
        if self._tab_scroll_buttons_shown:
            ...
            tabs_rect.SetWidth(
                tabs_rect.GetWidth() - self._tab_scroll_left_button_rect.GetWidth() - self._tab_scroll_right_button_rect.GetWidth())
    ...
    def OnMouseLeftDown(self, event):
        ...
        if tab and tab != self._pages[self._current_page]:
            ...
            if query.IsAllowed():
                ...
                notification = RibbonBarEvent(wxEVT_COMMAND_RIBBONBAR_PAGE_CHANGED, self.GetId(),
                                              self._pages[self._current_page].page)
        ...
        if show_right != (self._tab_scroll_right_button_rect.GetWidth() != 0) or \
            ...
            if show_left:
                self._tab_scroll_left_button_rect.SetWidth(
                    self._art.GetScrollButtonMinimumSize(temp_dc, self, RIBBON_SCROLL_BTN_LEFT |
