        ...
        * mxDateTimeDelta
        ...
        if isinstance(value, six.string_types):
            ...
            if not valid:
                ...
                try:
                    if wxdt.Format('%p') not in ('AM', 'PM') and checkTime in (5, 8):
                        ...
                        raise ValueError(
                            'cannot convert string "%s" to valid time for the current locale; please use 24hr time instead' % value)
                    else:
            ...
            if isinstance(value, wx.DateTime):
                ...
                if accept_mx:
                    error = 'GetWxDateTime requires wxDateTime, mxDateTime or parsable time string, passed %s' % repr(
                        value)
                else:
