    ...
    def Evaluate(self):
        ...
        if self._constraintType == CONSTRAINT_CENTRED_VERTICALLY:
            ...
            for constrainedObject in self._constrainedObjects:
                ...
                if not self.Equals(startX, constrainedObject.GetX()) or not self.Equals(startY,
                                                                                        constrainedObject.GetY()):
...
class CompositeShape(RectangleShape):
    ...
    def OnDragLeft(self, draw, x, y, keys=0, attachment=0):
        ...
        self.GetEventHandler().OnDrawOutline(dc, self.GetX() + offsetX, self.GetY() + offsetY, self.GetWidth(),
                                             self.GetHeight())
