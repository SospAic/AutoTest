...
class DividedShape(RectangleShape):
    ...
    def OnDrawContents(self, dc):
        ...
        for region in self.GetRegions():
            ...
            DrawFormattedText(dc, region._formattedText, centreX, centreY, self._width - 2 * xMargin,
                              actualY - currentY - 2 * yMargin, region._formatMode)
    ...
    def MakeMandatoryControlPoints(self):
        ...
        for i, region in enumerate(self.GetRegions()):
            ...
            if region != self.GetRegions()[-1]:
                controlPoint = DividedShapeControlPoint(self._canvas, self, i, CONTROL_POINT_SIZE, 0,
                                                        actualY - self.GetY(), 0)
