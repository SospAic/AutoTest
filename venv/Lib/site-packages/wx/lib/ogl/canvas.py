...
class ShapeCanvas(wx.ScrolledWindow):
    ...
    def __init__(self, parent=None, id=-1, pos=wx.DefaultPosition, size=wx.DefaultSize, style=wx.BORDER,
                 name="ShapeCanvas"):
    ...
    def OnMouseEvent(self, evt):
        ...
        if dragging and self._draggedShape and self._dragState == StartDraggingLeft:
            ...
            # Continue dragging
            self._draggedShape.GetEventHandler().OnDragLeft(False, self._oldDragX, self._oldDragY, keys,
                                                            self._draggedAttachment)
            ...
            # Continue dragging
            self._draggedShape.GetEventHandler().OnDragRight(False, self._oldDragX, self._oldDragY, keys,
                                                             self._draggedAttachment)
        ...
        for object in rl:
            ...
            if (object.IsShown() and
                ...
                if not isinstance(object, LineShape):
                    ...
                    if not nearest_object or not (
                            isinstance(object, DivisionShape) or WhollyContains(object, nearest_object)):
                        nearest_object = object
                        nearest_attachment = temp_attachment
                        break
