window.model = (function () {
    ...
    function Suite(data) {
        ...
        suite.callWhenChildrenReady = function (callable) {
            callable();
        };
    ...
    function Test(data) {
        ...
        test.formatParentName = function () {
            return util.formatParentName(test);
        };
...
window.stats = (function () {
    ...
    function Statistics(totalElems, tagElems, suiteElems) {
        return {
            total: util.map(totalElems, totalStatElem),
    ...
    function suiteStatElem(data) {
        ...
        stat.formatParentName = function () {
            return util.formatParentName(stat);
        };
        return stat;
    }
