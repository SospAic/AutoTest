...
def drop_fall(img):
    ...
    img1.save('./pic_code/cuts-d-1.png')
    ...
    img2.save('./pic_code/cuts-d-2.png')


def randomCodeOcr(filename='./pic_code/code.jpg'):
...
if __name__ == '__main__':
    processImg('./pic_code/vcode.jpg', './pic_code/code.jpg')
    p = Image.open('./pic_code/code.jpg')
    drop_fall(p)
    randomCodeOcr()
